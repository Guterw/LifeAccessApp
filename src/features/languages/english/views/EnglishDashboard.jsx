  ...
  return (
    <div className="w-full pt-8 animate-fade-in px-4 pb-24 -mt-5 -mb-20">
      ...
      <div className="w-full space-y-6">
        ...
        {/* CARD ESTATÍSTICAS (Compactado) */}
        <button 
          onClick={() => navigate('/english/stats')}
          className="w-full bg-gray-800 rounded-[2rem] p-5 border border-gray-700 shadow-xl block text-left hover:border-blue-500 transition-all group"
        >
          ...
          <div className="flex justify-between items-center px-2">
            <div className="flex flex-col items-center flex-1">
              ...
              <span className="text-[8px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Ofensiva</span>
            </div>
            <div className="w-px h-8 bg-gray-700"></div>
            <div className="flex flex-col items-center flex-1">
              <BookOpen className="text-green-500 mb-1" size={20} />
              <span className="text-white font-black text-lg">{learnedCount}</span>
              <span className="text-[8px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Aprendidas</span>
            </div>
            <div className="w-px h-8 bg-gray-700"></div>
            <div className="flex flex-col items-center flex-1">
              <AlertTriangle className="text-red-400 mb-1" size={20} />
              <span className="text-white font-black text-lg">{mistakesCount}</span>
              <span className="text-[8px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Revisar</span>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-base font-black text-white">Jornada Guiada</h3>
              <p className="text-[9px] font-bold tracking-widest text-indigo-300 uppercase">Siga a Trilha</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <h3 className="text-base font-black text-white">Fundamentos</h3>
              <p className="text-[10px] text-blue-100 font-medium">Alfabeto e Números</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              <h3 className="text-base font-black text-white">Professor IA</h3>
              <p className="text-[10px] text-purple-100 font-medium">Conversação e Treino</p>
            </div>
          </div>
          <ChevronRight className="text-white/70" />
        </button>
