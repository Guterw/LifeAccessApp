...
export const translations = {
  pt: {
    ...
    diet: {
      title: "Dieta",
      subtitle: "Alimentação e Hidratação",
      introTitle: "Vamos montar sua dieta",
      introDesc: "Responda algumas perguntas rápidas. No final, nossa IA vai montar uma sugestão de dieta personalizada — e você pode editar tudo depois.",
      goalQuestion: "Qual seu objetivo principal?",
      mealsQuestion: "Quantas refeições você faz por dia?",
      restrictionsQuestion: "Alguma restrição ou alergia alimentar?",
      restrictionsPlaceholder: "Ex: lactose, glúten, vegetariano... (opcional)",
      likedQuestion: "Do que você mais gosta de comer?",
      likedPlaceholder: "Ex: frango grelhado, arroz, frutas...",
      dislikedQuestion: "Do que você NÃO gosta / não quer comer?",
      dislikedPlaceholder: "Ex: peixe, brócolis...",
      difficultyQuestion: "Que alimentos você tem dificuldade de abandonar?",
      difficultyDesc: "Sem julgamentos! Vamos incluir com moderação para o plano ser sustentável.",
      difficultyPlaceholder: "Ex: refrigerante, doces, fast food...",
      generating: "Gerando sua dieta com IA...",
      generateBtn: "Gerar minha dieta",
      generateError: "Não foi possível gerar automaticamente. Você pode editar manualmente depois.",
      planReadyTitle: "Sua dieta sugerida",
      dailyTarget: "Meta Diária",
      waterGoal: "Meta de Água",
      tips: "Dicas",
      confirmPlan: "Usar esta dieta",
      editAnswers: "Voltar e editar respostas",
      tdeeReferenceNote: "Meta baseada no seu gasto calórico estimado de",
      scannerTitle: "Escanear Prato",
      scannerSubtitle: "Tire uma foto e a IA estima as calorias",
      takePhoto: "Tirar Foto",
      fromGallery: "Da Galeria",
      analyzing: "Analisando o prato com IA...",
      analyzingDesc: "Isso pode levar alguns segundos.",
      scanError: "Não foi possível analisar a foto. Verifique sua conexão e tente novamente.",
      saveError: "Erro ao salvar os itens no seu diário.",
      tryAgain: "Tentar novamente",
      totalEstimated: "Total Estimado",
      unnamedItem: "Item",
      itemNamePlaceholder: "Nome do alimento",
      grams: "Gramas (aprox.)",
      calories: "Calorias",
      noItemsFound: "Nenhum item identificado. Adicione manualmente abaixo.",
      addItemManually: "Adicionar item manualmente",
      scanAgain: "Nova Foto",
      confirmAndSave: "Confirmar e Salvar",
      saved: "Salvo!",
      reportTitle: "Relatório de Consumo",
      reportSubtitle: "Acompanhe sua evolução ao longo do tempo",
      period7: "7 dias",
      period14: "14 dias",
      period30: "30 dias",
      avgCalories: "Média de Calorias",
      avgWater: "Média de Água",
      caloriesChart: "Calorias Consumidas vs Meta",
      withinTarget: "Dentro da meta",
      overTarget: "Acima da meta",
      targetLine: "Meta",
      waterChart: "Água Consumida por Dia",
      dailyBreakdown: "Detalhamento Diário",
      noHistory: "Nenhum registro neste período ainda.",
      noEntries: "Sem registros",
      editProfileTitle: "Editar Minha Dieta",
      editMyDiet: "Editar minha dieta",
      mealsSection: "Refeições do Plano",
      mealNamePlaceholder: "Ex: Café da Manhã",
      mealSuggestionPlaceholder: "Descrição da refeição",
      noMealsYet: "Nenhuma refeição cadastrada ainda.",
      addMeal: "Adicionar refeição",
      saveChanges: "Salvar Alterações",
      mealsHint: "Inclui até quem prefere fazer só 1 ou 2 refeições por dia (OMAD/jejum).",
      fastingQuestion: "Você pratica ou quer praticar jejum intermitente?",
      fastingDesc: "Isso ajuda a IA a organizar melhor a janela das suas refeições.",
      fastingYes: "Sim, quero",
      fastingNo: "Não, obrigado",
      fastingProtocolQuestion: "Escolha o protocolo de jejum",
      startFastingNow: "Ativar meu jejum agora mesmo (iniciar a contagem)",
      fastingLinkedNote: "Jejum intermitente vinculado",
      tdeeReferenceNoteTdee: "Meta baseada no seu gasto calórico estimado de",
      todayEntries: "Consumido Hoje",
    },
  },
  ...
  en: {
    ...
    diet: {
      ...
      introTitle: "Let's build your diet",
      introDesc: "Answer a few quick questions. At the end, our AI will build a personalized diet suggestion — and you can edit everything afterwards.",
      goalQuestion: "What's your main goal?",
      mealsQuestion: "How many meals do you have per day?",
      restrictionsQuestion: "Any dietary restrictions or allergies?",
      restrictionsPlaceholder: "E.g: lactose, gluten, vegetarian... (optional)",
      likedQuestion: "What do you like eating the most?",
      likedPlaceholder: "E.g: grilled chicken, rice, fruit...",
      dislikedQuestion: "What do you NOT like / don't want to eat?",
      dislikedPlaceholder: "E.g: fish, broccoli...",
      difficultyQuestion: "What foods do you find hard to give up?",
      difficultyDesc: "No judgment! We'll include them in moderation to make the plan sustainable.",
      difficultyPlaceholder: "E.g: soda, sweets, fast food...",
      generating: "Generating your diet with AI...",
      generateBtn: "Generate my diet",
      generateError: "Could not generate automatically. You can edit it manually afterwards.",
      planReadyTitle: "Your suggested diet",
      dailyTarget: "Daily Target",
      waterGoal: "Water Goal",
      tips: "Tips",
      confirmPlan: "Use this diet",
      editAnswers: "Go back and edit answers",
      tdeeReferenceNote: "Target based on your estimated calorie expenditure of",
      scannerTitle: "Scan Meal",
      scannerSubtitle: "Take a photo and AI estimates the calories",
      takePhoto: "Take Photo",
      fromGallery: "From Gallery",
      analyzing: "Analyzing the meal with AI...",
      analyzingDesc: "This may take a few seconds.",
      scanError: "Could not analyze the photo. Check your connection and try again.",
      saveError: "Error saving the items to your log.",
      tryAgain: "Try again",
      totalEstimated: "Total Estimated",
      unnamedItem: "Item",
      itemNamePlaceholder: "Food name",
      grams: "Grams (approx.)",
      calories: "Calories",
      noItemsFound: "No items identified. Add manually below.",
      addItemManually: "Add item manually",
      scanAgain: "New Photo",
      confirmAndSave: "Confirm and Save",
      saved: "Saved!",
      reportTitle: "Consumption Report",
      reportSubtitle: "Track your progress over time",
      period7: "7 days",
      period14: "14 days",
      period30: "30 days",
      avgCalories: "Average Calories",
      avgWater: "Average Water",
      caloriesChart: "Calories Consumed vs Target",
      withinTarget: "Within target",
      overTarget: "Over target",
      targetLine: "Target",
      waterChart: "Water Consumed per Day",
      dailyBreakdown: "Daily Breakdown",
      noHistory: "No records in this period yet.",
      noEntries: "No records",
      editProfileTitle: "Edit My Diet",
      editMyDiet: "Edit my diet",
      mealsSection: "Plan Meals",
      mealNamePlaceholder: "E.g: Breakfast",
      mealSuggestionPlaceholder: "Meal description",
      noMealsYet: "No meals registered yet.",
      addMeal: "Add meal",
      saveChanges: "Save Changes",
      mealsHint: "Includes those who prefer just 1 or 2 meals a day (OMAD/fasting).",
      fastingQuestion: "Do you practice or want to practice intermittent fasting?",
      fastingDesc: "This helps the AI better organize your eating window.",
      fastingYes: "Yes, I want to",
      fastingNo: "No, thanks",
      fastingProtocolQuestion: "Choose your fasting protocol",
      startFastingNow: "Start my fast right now (begin the timer)",
      fastingLinkedNote: "Intermittent fasting linked",
      tdeeReferenceNoteTdee: "Target based on your estimated calorie expenditure of",
      todayEntries: "Consumed Today",
    },
  },
  ...
  es: {
    ...
    diet: {
      title: "Dieta",
      subtitle: "Alimentación e Hidratación",
      introTitle: "Vamos a armar tu dieta",
      introDesc: "Responde algunas preguntas rápidas. Al final, nuestra IA armará una sugerencia de dieta personalizada — y podrás editar todo después.",
      goalQuestion: "¿Cuál es tu objetivo principal?",
      mealsQuestion: "¿Cuántas comidas haces al día?",
      restrictionsQuestion: "¿Alguna restricción o alergia alimentaria?",
      restrictionsPlaceholder: "Ej: lactosa, gluten, vegetariano... (opcional)",
      likedQuestion: "¿Qué es lo que más te gusta comer?",
      likedPlaceholder: "Ej: pollo a la plancha, arroz, frutas...",
      dislikedQuestion: "¿Qué NO te gusta / no quieres comer?",
      dislikedPlaceholder: "Ej: pescado, brócoli...",
      difficultyQuestion: "¿Qué alimentos te cuesta abandonar?",
      difficultyDesc: "¡Sin juicios! Los incluiremos con moderación para que el plan sea sostenible.",
      difficultyPlaceholder: "Ej: refresco, dulces, comida rápida...",
      generating: "Generando tu dieta con IA...",
      generateBtn: "Generar mi dieta",
      generateError: "No se pudo generar automáticamente. Puedes editarlo manualmente después.",
      planReadyTitle: "Tu dieta sugerida",
      dailyTarget: "Meta Diaria",
      waterGoal: "Meta de Agua",
      tips: "Consejos",
      confirmPlan: "Usar esta dieta",
      editAnswers: "Volver y editar respuestas",
      tdeeReferenceNote: "Meta basada en tu gasto calórico estimado de",
      scannerTitle: "Escanear Plato",
      scannerSubtitle: "Toma una foto y la IA estima las calorías",
      takePhoto: "Tomar Foto",
      fromGallery: "De la Galería",
      analyzing: "Analizando el plato con IA...",
      analyzingDesc: "Esto puede tardar unos segundos.",
      scanError: "No se pudo analizar la foto. Verifica tu conexión e intenta de nuevo.",
      saveError: "Error al guardar los elementos en tu diario.",
      tryAgain: "Intentar de nuevo",
      totalEstimated: "Total Estimado",
      unnamedItem: "Elemento",
      itemNamePlaceholder: "Nombre del alimento",
      grams: "Gramos (aprox.)",
      calories: "Calorías",
      noItemsFound: "Ningún elemento identificado. Agrega manualmente abajo.",
      addItemManually: "Agregar elemento manualmente",
      scanAgain: "Nueva Foto",
      confirmAndSave: "Confirmar y Guardar",
      saved: "¡Guardado!",
      reportTitle: "Informe de Consumo",
      reportSubtitle: "Sigue tu progreso a lo largo del tiempo",
      period7: "7 días",
      period14: "14 días",
      period30: "30 días",
      avgCalories: "Promedio de Calorías",
      avgWater: "Promedio de Agua",
      caloriesChart: "Calorías Consumidas vs Meta",
      withinTarget: "Dentro de la meta",
      overTarget: "Por encima de la meta",
      targetLine: "Meta",
      waterChart: "Agua Consumida por Día",
      dailyBreakdown: "Detalle Diario",
      noHistory: "Aún no hay registros en este período.",
      noEntries: "Sin registros",
      editProfileTitle: "Editar Mi Dieta",
      editMyDiet: "Editar mi dieta",
      mealsSection: "Comidas del Plan",
      mealNamePlaceholder: "Ej: Desayuno",
      mealSuggestionPlaceholder: "Descripción de la comida",
      noMealsYet: "Aún no hay comidas registradas.",
      addMeal: "Agregar comida",
      saveChanges: "Guardar Cambios",
      mealsHint: "Incluye a quienes prefieren solo 1 o 2 comidas al día (OMAD/ayuno).",
      fastingQuestion: "¿Practicas o quieres practicar el ayuno intermitente?",
      fastingDesc: "Esto ayuda a la IA a organizar mejor tu ventana de alimentación.",
      fastingYes: "Sí, quiero",
      fastingNo: "No, gracias",
      fastingProtocolQuestion: "Elige tu protocolo de ayuno",
      startFastingNow: "Activar mi ayuno ahora mismo (iniciar el conteo)",
      fastingLinkedNote: "Ayuno intermitente vinculado",
      tdeeReferenceNoteTdee: "Meta basada en tu gasto calórico estimado de",
      todayEntries: "Consumido Hoy",
    },
  }
};