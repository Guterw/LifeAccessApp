  ...
  return (
    <div className={`flex ${direction} items-center justify-center gap-3 py-2 opacity-30 select-none`}>
      ...
      <a 
        ...
        className={`flex items-center gap-1 ${textSize} ${textColor} hover:text-blue-400 transition-colors`}
      >
        <GithubIcon style={{ width: '1em', height: '1em' }} />
        <span>github.com/Guterw</span>
      </a>
    </div>
  );
}